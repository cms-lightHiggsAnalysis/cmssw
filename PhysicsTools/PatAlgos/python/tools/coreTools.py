...
class RunOnData(ConfigToolBase):
    ...
    def __init__(self):
        ...
        self.addParameter(self._defaultParameters,'names',['All'], "collection name; supported are 'Photons', 'Electrons','Muons', 'Taus', 'TausBoosted', 'TausElectronCleaned', 'Jets', 'METs', 'All', 'PFAll', 'PFElectrons','PFTaus','PFMuons'", allowedValues=['Photons', 'Electrons','Muons', 'Taus', 'TausBoosted','TausElectronCleaned', 'Jets', 'METs', 'All', 'PFAll', 'PFElectrons','PFTaus','PFMuons'])
...
class RemoveMCMatching(ConfigToolBase):
    ...
    def __init__(self):
        ...
        self.addParameter(self._defaultParameters,'names',['All'],
                          "collection name; supported are 'Photons', 'OOTPhotons', 'Electrons','Muons', 'Taus', 'TausBoosted', 'TausMuonCleaned', 'TausElectronCleaned', 'Jets', 'METs', 'All', 'PFAll', 'PFElectrons','PFTaus','PFMuons'", 
                          allowedValues=['Photons', 'Electrons','Muons', 'Taus', 'TausBoosted','TausMuonCleaned', 'TausElectronCleaned', 'Jets', 'METs', 'All', 'PFAll', 'PFElectrons','PFTaus','PFMuons'])
        self.addParameter(self._defaultParameters,'postfix',"", "postfix of default sequence")
        self.addParameter(self._defaultParameters,'outputModules',['out'], "names of all output modules specified to be adapted (default is ['out'])")
        self._parameters=copy.deepcopy(self._defaultParameters)
        self._comment = ""
    ...
    def toolCode(self, process):
        ...
        for obj in range(len(names)):
            ...
            if( names[obj] == 'TausElectronCleaned'      or names[obj] == 'All' ):
